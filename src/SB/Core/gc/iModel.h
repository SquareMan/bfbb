...
U32 iModelVertEval(RpAtomic* model, U32 index, U32 count, RwMatrix* mat, xVec3* vert,
                   xVec3* dest);
...
U32 iModelNormalEval(xVec3* out, const RpAtomic& m, const RwMatrix* mat, size_t index,
